...
ADMIN_HELP_TEXT = (
    ...
    "/bookmark_watch - 开始盯 Twitter / Pixiv / Poipiku / Danbooru bookmark 喵\n\n"
...
BOOKMARK_WATCH_UNAVAILABLE = "😿 bookmark 监控还没配置好喵，请先设置可用的 Twitter token、Pixiv / Poipiku cookie 或 Danbooru API key。"
BOOKMARK_WATCH_STARTED = "✅ bookmark 监控已开启喵！Twitter / Pixiv / Poipiku / Danbooru 中已配置的来源会一起检查，每30秒一次，2分钟没有更新会自动关闭。"
